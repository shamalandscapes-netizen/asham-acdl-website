...
// ✅ FIX: Removed curly braces { } for default export
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-dark/5 to-green-light/5">
        <div className="w-full max-w-md p-8 text-center bg-white shadow-xl rounded-2xl">
          ...
          <h1 className="mb-4 text-3xl font-bold text-green-dark">Registration Successful!</h1>
      ...
      <div className="w-full max-w-md p-8 bg-white shadow-xl rounded-2xl">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full py-3 pl-10 pr-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-light focus:border-transparent"
        ...
        <div className="pt-6 mt-8 border-t">
          <p className="text-center text-gray-600">
            ...
            <Link href="/login" className="font-medium text-green-light hover:text-green-dark">
              Sign in
            </Link>
          </p>
